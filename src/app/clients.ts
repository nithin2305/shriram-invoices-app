...
export const CLIENTS: CustomerDetails[] = [
  ...
  { name: 'M/S. GERMAN POLYMERS AND COATINGS PVT LIMITED', addressLine1: 'NO. 18, OTHIVAKKAM SF NO.82/1, 88/6B, 100/F, 1G, 3, 4', addressLine2: 'KUMUZHI VILLAGE, VANDALUR TALUK, CHENGALPATTU – 603202', gstNo: '33AABCG1253F1Z7' },
  { name: 'M/S. GLOBAL LOGISTICS INDIA', addressLine1: 'BIHAR', addressLine2: '', gstNo: '10HEGPK7214M1ZG' },
  { name: 'M/S. KONKAN ROADWAYS', addressLine1: 'KOLKATA', addressLine2: '', gstNo: '' },
